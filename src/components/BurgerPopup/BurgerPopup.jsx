...
const BurgerPopup = ({ isPopupOpened, handlePopupOpen }) => {
  ...
  const putActive = ({ isActive }) => isActive ? "burger-button__nav_active burger-button__nav-item" : 'burger-button__nav-item';
    ...
    <div className={`burger-button ${isPopupOpened ? 'burger-popup_is_opened' : ''}`}>
      <div className='burger-button__container'>
        ...
        <nav className="burger-button__nav">
          <NavLink to="/" className={putActive}>
            Главная
          </NavLink>
          <NavLink to="/movies" className={putActive}>
            Фильмы
          </NavLink>
